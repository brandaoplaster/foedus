defmodule FoedusWeb.Components.UI.HeroSection do
  ...
  import FoedusWeb.Components.UI.{BackgroundPattern, BrandLogo, HeroContent, FeaturesPreview, FloatingElements, Button}
  ...
  attr :hero_subtitle, :string, default: "Generate, manage and streamline your contract templates with intelligent automation and seamless workflow integration."
