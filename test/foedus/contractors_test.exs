defmodule Foedus.ContractorsTest do
  ...
  describe "contractors" do
    ...
    @invalid_attrs %{
      ...
      cnpj: nil,
      company_type: nil,
      legal_representative_first_name: nil,
      legal_representative_last_name: nil,
      legal_representative_cpf: nil,
      legal_representative_birth_date: nil,
      legal_representative_email: nil,
      authorized_representative_first_name: nil,
      authorized_representative_last_name: nil,
      authorized_representative_cpf: nil,
      authorized_representative_birth_date: nil,
    ...
    test "create_contractor/1 with valid data creates a contractor" do
      ...
      assert contractor.authorized_representative_first_name ==
               "some authorized_representative_first_name"

      assert contractor.authorized_representative_last_name ==
               "some authorized_representative_last_name"
    ...
    test "update_contractor/2 with valid data updates the contractor" do
      ...
      update_attrs = %{
        ...
        company_type: "some updated company_type",
        legal_representative_first_name: "some updated legal_representative_first_name",
        legal_representative_last_name: "some updated legal_representative_last_name",
        legal_representative_cpf: "some updated legal_representative_cpf",
        legal_representative_birth_date: ~D[2025-09-09],
        legal_representative_email: "some updated legal_representative_email",
        authorized_representative_first_name: "some updated authorized_representative_first_name",
        authorized_representative_last_name: "some updated authorized_representative_last_name",
        authorized_representative_cpf: "some updated authorized_representative_cpf",
        authorized_representative_birth_date: ~D[2025-09-09],
        authorized_representative_email: "some updated authorized_representative_email",
        ...
        address_neighborhood: "some updated address_neighborhood",
        address_city: "some updated address_city",
        address_state: "some updated address_state",
        address_zipcode: "some updated address_zipcode",
      ...
      assert contractor.legal_representative_first_name ==
               "some updated legal_representative_first_name"

      assert contractor.legal_representative_last_name ==
               "some updated legal_representative_last_name"
      ...
      assert contractor.authorized_representative_first_name ==
               "some updated authorized_representative_first_name"

      assert contractor.authorized_representative_last_name ==
               "some updated authorized_representative_last_name"

      assert contractor.authorized_representative_cpf ==
               "some updated authorized_representative_cpf"

      assert contractor.authorized_representative_birth_date == ~D[2025-09-09]

      assert contractor.authorized_representative_email ==
               "some updated authorized_representative_email"
